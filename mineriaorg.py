...
#     st.warning("⚠️ No se detectaron columnas de departamentos ('*Enrolled'). Se usará 'General' por defecto.")
...
# 
# if faltantes:
#     st.error(f"❌ Faltan las siguientes columnas en tu archivo: {', '.join(faltantes)}")
#     st.stop()
# 
# # ========================
...
# # ========================
# st.markdown("---")
# st.subheader("💬 Interacción de ejemplo")
# user_input = st.text_input("Escribe algo aquí:", "Hola Streamlit!")
